...
export default function PaymentFailedSlicing() {
  return (
    <div className={`${inter.className} min-h-screen bg-gray-100`}>
      ...
      <div className="max-w-2xl mx-auto px-4 md:px-8 py-12">
        ...
        <p className="text-sm text-gray-500 text-center mb-8">
          Don't worry, no funds were deducted. Your offer from Jhonny Doe is still saved.
        </p>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 mb-6">
          <div className="flex items-start justify-between mb-4">
            ...
            <span className="text-xs font-semibold text-red-400 bg-red-50 border border-red-200 rounded-full px-3 py-1">Unpaid</span>
          </div>
