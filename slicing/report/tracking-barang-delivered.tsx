...
export default function TrackingBarangDeliveredSlicing() {
  return (
          ...
          <div className="flex-1 flex flex-col gap-4">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-5">
              <div className="flex items-start justify-between mb-1">
                ...
                <span className="text-sm font-semibold text-orange-400">Action Required</span>
              </div>
              ...
              <div className="relative">
                ...
                <div className="flex gap-4 mb-0">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="w-px flex-1 bg-[#49BC9E] min-h-[80px]"></div>
                  </div>
                  <div className="flex-1 pb-6">
                ...
                <div className="flex gap-4 mb-0">
                  <div className="flex flex-col items-center">
                  <div className="w-10 h-10 rounded-full border-2 border-[#49BC9E] bg-white flex items-center justify-center z-10">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-[#49BC9E]">
                  ...
                  <div className="flex-1 pb-6">
                  <p className="text-sm font-bold text-[#49BC9E] mb-1">In Transit</p>
                  <p className="text-sm text-gray-500">Jastiper has arrived in Indonesia.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 mb-0">
                  <div className="flex flex-col items-center">
                  <div className="w-10 h-10 rounded-full border-2 border-orange-400 bg-white flex items-center justify-center z-10">
                  ...
                  <div className="flex-1 pb-6">
                  <p className="text-sm font-bold text-orange-400 mb-1">Delivered</p>
                    <p className="text-sm text-gray-500 mb-3">Item has been delivered. Please inspect the item. You have 3 days to confirm receipt or report an issue.</p>

                    {/* Confirmation Box */}
                    <div className="bg-orange-50 border border-orange-100 rounded-lg p-4">
                    <p className="text-sm font-bold text-orange-500 mb-1">Confirmation Deadline</p>
                    <p className="text-xs text-orange-400 mb-3">Funds will be auto-released if no action is taken.</p>
                    <div className="flex flex-col gap-2">
                        <button className="flex items-center justify-center gap-2 bg-[#49BC9E] hover:bg-[#3da88d] transition-colors text-white text-sm font-semibold py-2.5 rounded-lg">
                        <span>✓</span> Confirm & Release
                        </button>
                        <button className="flex items-center justify-center gap-2 border border-orange-300 text-sm font-semibold text-orange-500 py-2.5 rounded-lg hover:bg-orange-50 transition-colors">
