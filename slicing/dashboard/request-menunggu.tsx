...
export default function RequestMenungguSlicing() {
  return (
    <div className={`${inter.className} min-h-screen bg-gray-100`}>
      ...
      <div className="max-w-4xl mx-auto px-8 py-8">
        ...
        <div className="flex items-center gap-6 border-b border-gray-200 mb-6">
          ...
          <button className="pb-3 text-sm text-gray-500 hover:text-gray-700 transition-colors border-b-2 border-transparent">Tagihan</button>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            {/* Status Badge */}
            <span className="flex-shrink-0 ml-4 text-xs font-semibold text-orange-400 bg-orange-50 border border-orange-200 rounded-full px-3 py-1">
              Menunggu
            </span>
          </div>
