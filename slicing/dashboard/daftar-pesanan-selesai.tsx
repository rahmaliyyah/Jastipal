...
export default function DaftarPesananSelesaiSlicing() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-8 py-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            <span className="flex-shrink-0 ml-4 text-xs font-semibold text-[#49BC9E] bg-[#e6f7f3] rounded-full px-3 py-1">Selesai</span>
          </div>

          {/* Progress Steps - semua aktif kecuali step 4 */}
