...
export default function DaftarPesananDibatalkanSlicing() {
  return (
    <div className={`${inter.className} min-h-screen bg-gray-100`}>
      ...
      <div className="max-w-4xl mx-auto px-8 py-8">
        ...
        <div className="flex items-center gap-6 border-b border-gray-200 mb-6">
          ...
          <button className="pb-3 text-sm text-gray-500 border-b-2 border-transparent">Dikirim</button>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            <span className="flex-shrink-0 ml-4 text-xs font-semibold text-red-400 bg-red-50 border border-red-200 rounded-full px-3 py-1">Pesanan Dibatalkan</span>
          </div>
          ...
          <div className="border border-gray-200 rounded-lg p-4 mb-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center gap-2 border border-gray-200 rounded-lg px-4 py-3 cursor-pointer hover:bg-gray-50 transition-colors">
          ...
          <div className="bg-red-50 rounded-lg px-4 py-3">
            <p className="text-sm font-semibold text-red-500 mb-1">Pesanan dibatalkan akibat komplain</p>
            <p className="text-sm text-red-400">Alasan: Bukti foto yang dikirim jastiper terindikasi hasil AI</p>
          </div>
