...
export default function FormRequestMeetupSlicing() {
  return (
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                {/* Kirim Paket - tidak aktif */}
                <div className="flex items-center gap-2 border border-gray-200 rounded-lg px-4 py-3 cursor-pointer">
                ...
                {/* Meetup - aktif */}
                <div className="flex items-center gap-2 border border-[#49BC9E] bg-[#f0faf7] rounded-lg px-4 py-3 cursor-pointer">
                  ...
                  <span className="text-sm text-[#49BC9E] font-medium">Meetup / Ketemuan</span>
                </div>
              </div>
              {/* Tanggal Meetup */}
              <div className="mb-4">
                <label className="block text-sm font-medium text-gray-700 mb-1.5">Tanggal Meetup</label>
                <div className="flex items-center gap-2 border border-gray-200 rounded-lg px-3 py-2.5">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-gray-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  <input type="text" placeholder="29/04/2026" className="flex-1 text-sm text-gray-400 placeholder-gray-400 outline-none bg-transparent" />
                </div>
              </div>
              {/* Lokasi Meetup */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">Lokasi Meetup</label>
                <input
                  type="text"
                  placeholder="Mall of Olympic Garden, Kota Malang"
                  className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-400 placeholder-gray-400 outline-none focus:border-[#49BC9E] transition-colors"
                />
                <br></br>
              </div>
