        ...
        <div className="bg-white rounded-xl border-2 border-blue-300 border-dashed p-8">
          ...
          <div className="border border-gray-200 rounded-xl p-5 mb-4">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
                ...
                <span className="text-sm font-medium text-[#49BC9E]">Meetup / Ketemuan</span>
                </div>
            </div>
            ...
            <div className="mb-4">
                ...
                <span className="text-sm text-gray-700">29/04/2026</span>
                </div>
            </div>
            ...
            <div>
                ...
                <input
                type="text"
                defaultValue="Mall of Olympic Garden, Kota Malang"
                className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-700 outline-none focus:border-[#49BC9E] transition-colors"
                />
            </div>
            </div>
