            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                ...
                <div className="flex items-center gap-2 border border-[#49BC9E] bg-[#f0faf7] rounded-lg px-4 py-3 cursor-pointer">
                  ...
                  <span className="text-sm text-[#49BC9E] font-medium">Kirim Paket</span>
                </div>
                {/* Meetup - tidak aktif */}
              ...
              <div>
                ...
                <textarea
                  rows={2}
                  placeholder="Jl. Greenwood Golf I 7-21, Boro Teronggo, Tirtomoyo, Kec. Pakis, Kabupaten Malang, Jawa Timur 65154"
