...
export default function ProfileSlicing() {
  return (
    <div className={`${inter.className} min-h-screen bg-gray-100`}>
      ...
      <div className="max-w-3xl mx-auto px-8 py-8">
        ...
        {/* Card: Daftar sebagai Jastiper */}
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <h2 className="text-base font-bold text-gray-900 mb-1">Daftar sebagai Jastiper</h2>
          <p className="text-sm text-gray-500 mb-5">Jadilah jastiper dan bantu pembeli untuk belanja dari luar negeri.</p>
          <button className="w-full bg-[#49BC9E] hover:bg-[#3da88d] transition-colors text-white font-semibold text-sm py-3 rounded-lg">
            Daftar
          </button>
        </div>
