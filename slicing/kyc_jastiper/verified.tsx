...
export default function VerifiedSlicing() {
  return (
    <div className={`${inter.className} min-h-screen bg-gray-100`}>
      ...
      <div className="max-w-3xl mx-auto px-8 py-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 mb-4">
          ...
          {/* Card: Verified Jastiper */}
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <h2 className="text-base font-bold text-gray-900 mb-1">Verified Jastiper</h2>
            <p className="text-sm text-gray-500 mb-5">Kamu dapat beralih antara mode buyer dan jastiper kapan saja</p>
