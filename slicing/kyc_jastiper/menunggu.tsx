...
export default function MenungguSlicing() {
  return (
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 mb-4">
          ...
          <div className="bg-[#e6f7f3] border border-[#49BC9E] rounded-xl p-6">
            ...
            <p className="text-sm text-[#49BC9E]">
              Pengajuan Jastiper kamu sedang diproses. Kami akan memberitahu kamu setelah review kembali
            </p>
          </div>
