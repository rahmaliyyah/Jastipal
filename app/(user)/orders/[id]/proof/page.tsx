...
export default function UploadProofPage() {
  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC]">
      <div className="max-w-[900px] mx-auto px-4 sm:px-6 py-4 sm:py-2">

        {/* BACK */}
        <button
          onClick={() => router.back()}
          className="flex items-center gap-1 text-[#64748B] text-sm sm:text-[15px] hover:text-[#0F172A] transition-colors mb-4"
        >
          <ChevronLeft size={18} />
          Kembali
        </button>
        ...
        {/* HEADER */}
        <div className="mb-6">
          <h1 className="text-2xl sm:text-[28px] font-bold text-[#0F172A] leading-tight">
            Bukti Pembelian
          </h1>

          <p className="mt-1 text-sm sm:text-[15px] text-[#64748B] break-words">
            {order.product_name}
          </p>
        </div>
        ...
        {success && (
          <div className="mb-5 bg-[#e6f7f3] border border-[#b3e8d9] rounded-xl px-4 py-3">
            <p className="text-[#2d9b7f] text-sm font-medium leading-relaxed">
        ...
        {/* UPLOAD SECTION */}
        <div className="bg-white border border-[#CBD5E1] rounded-2xl p-4 sm:p-8 mb-6">
          <h2 className="text-lg sm:text-[20px] font-bold text-[#0F172A] mb-6">
          ...
          <div className="mb-6">
            ...
            <div
              ...
              className="border-2 border-dashed border-[#CBD5E1] rounded-xl min-h-[150px] sm:h-[160px] flex flex-col items-center justify-center text-center px-4 py-6 cursor-pointer hover:border-[#49BC9E] transition-all"
            >
              {receiptFile ? (
                <>
                  ...
                  <p className="text-sm font-semibold text-[#49BC9E] break-all">
                    {receiptFile.name}
                  </p>
          ...
          <div>
            ...
            <input
              ...
              className="hidden"
              onChange={e => setBoardingFile(e.target.files?.[0] ?? null)}
            />
          </div>
        </div>
        ...
        {order.delivery_pref === 'courier' && (
          <div className="bg-white border border-[#CBD5E1] rounded-2xl p-4 sm:p-8 mb-6">
            <h2 className="text-lg sm:text-[20px] font-bold text-[#0F172A] mb-5">
              Nomor Resi
            </h2>
            ...
            <div className="mb-5">
              ...
              <input
                ...
                className="w-full h-12 rounded-xl border border-[#CBD5E1] px-4 text-sm text-gray-800 outline-none focus:border-[#49BC9E]"
              />
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-[#94A3B8] mt-1 leading-relaxed">
                Nomor resi akan ditampilkan ke buyer untuk tracking
              </p>
            </div>
          </div>
        )}
        ...
        <div className="flex justify-end">
          <button
            ...
            className="w-full sm:w-auto h-[52px] px-8 rounded-xl bg-[#49BC9E] hover:bg-[#3da88d] text-white font-semibold text-sm sm:text-[16px] shadow-lg shadow-teal-100 disabled:opacity-50 transition-all"
          >
            {submitting
              ? 'Mengirim...'
              : success
        ...
        {/* FOOTNOTE */}
        <p className="mt-4 text-center text-xs sm:text-[13px] text-[#94A3B8] leading-relaxed pb-8 px-2">
          {order.delivery_pref === 'courier'
