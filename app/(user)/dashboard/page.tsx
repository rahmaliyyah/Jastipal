          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-blue-800">
                {pendingPaymentCount} tagihan menunggu pembayaran
              </p>

              <p className="text-xs text-blue-600">
                Bayar sebelum kadaluarsa
              </p>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            ...
            <div
              ...
              className="bg-white rounded-xl p-4 sm:p-6 border border-gray-200 hover:shadow-sm transition-shadow cursor-pointer"
            >
              ...
              <p className="text-sm text-gray-500">
                Cari produk yang telah disediakan oleh jastiper di seluruh negeri
              </p>
            </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            ...
            >
              ...
              <p className="text-sm text-gray-500">
                Cari permintaan buyer yang bisa diambil
              </p>
            </div>
            ...
            >
              ...
              <p className="text-sm text-gray-500">
                Upload perjalanan dan katalog produkmu
              </p>
            </div>
          </div>
          ...
          <div
            ...
            className="bg-white rounded-xl p-4 sm:p-6 border border-gray-200 hover:shadow-sm transition-shadow cursor-pointer mb-4"
          >
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="text-xs text-[#49BC9E] hover:underline"
              >
                Lihat semua →
              </button>
            </div>
